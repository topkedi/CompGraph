...
{
  XMStoreFloat3(&m_position, XMVector3Transform(XMLoadFloat3(&m_position), XMMatrixTranslation(m_forwardVector.x * m_moveSpeed, m_forwardVector.y * m_moveSpeed, m_forwardVector.z * m_moveSpeed)));
...
void Camera::MoveLeft()
{
  ...
  XMStoreFloat3(&m_position, XMVector3Transform(XMLoadFloat3(&m_position), XMMatrixTranslation(-rightVector.x * m_moveSpeed, -rightVector.y * m_moveSpeed, -rightVector.z * m_moveSpeed)));
...
void Camera::RotatePitch(float degrees)
{
  ...
  // Clamp pitch to avoid flipping (-89 to 89 degrees)
